...
user in an INI file next to SpybotPortable.exe called SpybotPortable.ini. If you
...
AppNamePortable.ini from this directory to SpybotPortable.ini next to
SpybotPortable.exe. The options in the INI file are as follows:
