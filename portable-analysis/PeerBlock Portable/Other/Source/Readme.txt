...
user in an INI file next to PeerBlockPortable.exe called PeerBlockPortable.ini.
...
copy AppNamePortable.ini from this directory to PeerBlockPortable.ini next to
PeerBlockPortable.exe. The options in the INI file are as follows:
