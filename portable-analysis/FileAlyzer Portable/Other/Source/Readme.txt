...
user in an INI file next to FileAlyzerPortable.exe called FileAlyzerPortable.ini.
...
copy AppNamePortable.ini from this directory to FileAlyzerPortable.ini next to
FileAlyzerPortable.exe. The options in the INI file are as follows:
