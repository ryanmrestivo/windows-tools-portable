...
user in an INI file next to XnViewPortable.exe called XnViewPortable.ini.
...
copy AppNamePortable.ini from this directory to XnViewPortable.ini next to
XnViewPortable.exe. The options in the INI file are as follows:
