...
user in an INI file next to WhoDatPortable.exe called WhoDatPortable.ini.
...
copy AppNamePortable.ini from this directory to WhoDatPortable.ini next to
WhoDatPortable.exe. The options in the INI file are as follows:
