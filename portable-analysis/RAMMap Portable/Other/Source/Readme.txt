...
user in an INI file next to RAMMapPortable.exe called RAMMapPortable.ini.
...
copy AppNamePortable.ini from this directory to RAMMapPortable.ini next to
RAMMapPortable.exe. The options in the INI file are as follows:
